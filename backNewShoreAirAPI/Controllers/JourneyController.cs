...
namespace backNewShoreAirAPI.Controllers
{
    ...
    public class JourneyController : ControllerBase
    {
        ...
        {
            var flight = _disponibilityBusiness.GetDisponibility(new DomainLayer.Models.Request() { Origin = origin, Destination = destination });
            return Ok(flight);
        }
